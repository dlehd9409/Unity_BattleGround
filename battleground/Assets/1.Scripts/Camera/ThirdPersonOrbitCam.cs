...
// 충돌체크 : 이중 충돌 체크 기능 (캐릭터로부터 카메라, 카메라로부터 캐릭터)
// 사격 반동 위한 기능
// FOV 변경 기능
...
public class ThirdPersonOrbitCam : MonoBehaviour
{
    ...
    public float maxVerticalAngle = 30.0f; // 카메라의 수직 최대각도
    public float minVerticalAngle = -60.0f; // 카메라의 수직 최소각도
    ...
    private Vector3 smoothPivotOffset; // 카메라 피봇 보관용 벡터
    private Vector3 smoothCamOffset; // 카메라 위치 보관용 벡터
    private Vector3 targetPivotOffset; // 카메라 피봇 보관용 벡터
    private Vector3 targetCamOffset; // 카메라 위치 보관용 벡터
    ...
    public void SetTargerOffset(Vector3 newPivotOffset, Vector3 newCamOffset)
    {
    ...
    private void Update()
    {
        ...
        Vector3 noCollisionOffset = targetCamOffset; // 조준할때 카메라의 오프셋 값, 조준할때와 평소와 다름
