...
/// 루팅했으면 충돌체는 제거
/// 무기를 다시 버릴 수도 있어야 하며, 충돌체를 다시 생성한다.
/// 관련하여 UI도 컨트롤 할 수 있어야 하며
/// ShootBehaviour에 주운 무기를 넣어주게 된다.
/// </summary>
public class InteractiveWeapon : MonoBehaviour
{
    ...
    public int currentMagCapacity, totalBullets; // 현재 탄창 양, 소지하고 있는 전체 총알양
    private int fullMag, maxBullets; // 재장전시 꽉 채우는 탄의 양, 한번에 채울 수 있는 최대 총알양
