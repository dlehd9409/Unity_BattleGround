...
/// <summary>
/// state -> action update -> transition (decision 에 따라) check
/// state에 필요한 기능들 애니메이션 콜백등
...
public class StateController : MonoBehaviour
{
    ...
    public string classID; // pistol, rifie, ak
    ...
    [HideInInspector] public bool haveClearShot; // new
